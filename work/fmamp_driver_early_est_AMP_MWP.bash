...
[Early-est]
#--- Use Aref for amplitudes or Mwp, 1=Aref, 0=Mwp. type=int default=0
use_a_ref_for_amp=0
...
#gdb-apple --args fmamp -p fmamp_driver_early_est.prop
