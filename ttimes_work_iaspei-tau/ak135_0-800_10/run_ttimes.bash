...
MODEL_GRID_NAME=ak135_0-800_10

DEPTH="0.0 800.0 10.0"
DISTANCES="0.0 180.0 0.1"
...
PHASE_LIST="P Pdiff Pg  PKiKP   PKPab PKPbc PKPdf   PKKPab PKKPbc PKKPdf   PKPPKPab PKPPKPbc PKPPKPdf  PP S Sdiff Sg   SKSac SKSdf SKPdf   pP sP PcP ScP ScS   PKKSab PKKSbc PKKSdf   SKKSac SKKSdf"
...
y
${IASPEI_TAU_PATH}/build-tables/ak135
${PHASE}
${KEYWORD}
...
cat << END > times.tmp
static double dist_time[${N_PHASE}][1801][83] = {
END
...
cat << END > toang.tmp
static double dist_toang[${N_PHASE}][1801][83] = {
END
