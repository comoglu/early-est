...
c fit arrays
      ...
      pi=3.1415927
      degrad=180./pi
C 20110520 AJL - folowwing block gives on Mac OS X 10.6.7
C Program received signal EXC_BAD_ACCESS, Could not access memory.
C Reason: KERN_PROTECTION_FAILURE at address: 0x00013838
C 0x00005384 in focalmc_ (p_azi_mc=0x108300, p_the_mc=0x140c0, p_pol=0xbfffc08c, p_qual=0xbfffc85c, npsta=@0xbffff250, nmc=@0xbffff260, dang=@0xbffff2a8, maxout=@0x13838, nextra=@0xbffff264, ntotal=@0xbffff254, nf=@0xbffff25c, strike=0xbfffa91c, dip=0xbfffd7fc, rake=0xbfffb0ec, faults=0xbfff7078, slips=0xbfff87e8) at fmech_subs.f:55
C 55	      if (maxout.gt.500) then
C      if (maxout.gt.nmax0) then
C        maxout=nmax0
C      end if
