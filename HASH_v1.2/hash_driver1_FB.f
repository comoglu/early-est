c  Mon Jul  1 15:37:45 2013
c  florent.brenguier@ujf-grenoble.fr
c  Salut,
c  Voici le patch qui permet de lire du format hypoinverse, sortie NLL.
c  J'ai fixé les erreurs sur les angles de rais à 5° (il ne les lit plus dans le fichier),
c  a+
c  florent
...
35      format (a4,2x,a1,i1,50x,f4.1,i3,10x,i3,1x,i1,1x,i1) 
	isthe=5
	isazi=5
...
cc view polarity data
     ...
     &         p_azi_mc(k,2),p_the_mc(k,2),p_pol(k)
250   continue
