// travel times in the marsite1 model
//
// iaspei-tau (http://www.iris.edu/pub/programs/iaspei-tau/)
// modified AJL, use ttimes_ajl.f
//

#define MODEL_TTIME_NAME "R4_S3_T3_IASP91 (r4-s3-t3-iasp91_regional)"
...
// phase_ttime_error
//#define P_ERROR 1.0
#define P_ERROR 0.25        // 20130627 AJL (marsite)
//#define P_ERROR 0.1        // 20130524 AJL (marsite)
//#define P_ERROR 2.0
//
#define INVALID_ERROR -1.0
//#define S_ERROR 2.0*P_ERROR
#define S_ERROR 0.5        // 20130627 AJL (marsite)
//#define S_ERROR 0.2      // 20130524 AJL (marsite)
